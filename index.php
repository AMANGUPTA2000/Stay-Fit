<?php include 'includes/header.php'; ?>
    ...
    <section class="banner-section set-bg" style="opacity: 1.5;"data-setbg="img/cover-pic.jpg">
        <div class="container">
            <div class="row">
    ...
    <section class="content">
       <div class="text-content">
           <p>"Sometimes a workout therapy is all you need!"</p>
       </div>
    </section>
    <!-- Banner Section End -->
