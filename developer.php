...
<div class="container">
            ...
            <div class="row">
                <div class="column">
                    <div class="team-2">
                        <div class="team-img">
                            <img src="img/team/aman.jpg" alt="Team Image">
                            <div class="team-social">
                                <a target="_blank" class="social-tw" href="https://twitter.com/GuptaAmanR"><i class="fab fa-twitter"></i></a>
                                <a target="_blank" class="social-fb" href="https://twitter.com/GuptaAmanR"><i class="fab fa-facebook-f"></i></a>
                                <a target="_blank" class="social-li" href="https://www.linkedin.com/in/aman-gupta-949153184/"><i class="fab fa-linkedin-in"></i></a>
                                <a target="_blank" class="social-in" href="https://www.instagram.com/amangupta.r/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="team-content">
                            ...
                            <h4>aman.180410116028@gmail.com</h4>
                        </div>
                    </div>
                </div>
                <div class="column">
                    <div class="team-2">
                        <div class="team-img">
                            <img src="img/team/dhruv.jpg" alt="Team Image">
                            <div class="team-social">
                                <a target="_blank" class="social-tw" href="https://twitter.com/DhruvGa11685515"><i class="fab fa-twitter"></i></a>
                                <a target="_blank" class="social-fb" href="https://www.facebook.com/gandhi.dhruv.9/"><i class="fab fa-facebook-f"></i></a>
                                <a target="_blank" class="social-li" href="https://www.linkedin.com/in/dhruv-gandhi-506017213"><i class="fab fa-linkedin-in"></i></a>
                                <a target="_blank" class="social-in" href="https://www.instagram.com/dgandhi780/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="team-content">
                            <h2>Dhruv Gandhi</h2>
                            <h3>Developer</h3>
                            <p>Some text goes here that describes about team member</p>
                            <h4>dhruv.180410116022@gmail.com</h4>
                        </div>
                    </div>
                </div>
                <div class="column">
                    <div class="team-2">
                        <div class="team-img">
                            <img src="img/team/neehal.jpg" alt="Team Image">
                            <div class="team-social">
                                <a target="_blank" class="social-tw" href="https://twitter.com/SoniNeehal"><i class="fab fa-twitter"></i></a>
                                <a target="_blank" class="social-fb" href="https://www.facebook.com/neehal.hansoti/" ><i class="fab fa-facebook-f"></i></a>
                                <a target="_blank" class="social-li" href="https://www.linkedin.com/in/neehal-hansoti-77322a186/"><i class="fab fa-linkedin-in"></i></a>
                                <a target="_blank" class="social-in" href="https://www.instagram.com/neehalhansoti/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="team-content">
                            <h2>Neehal Hansoti</h2>
                            <h3>Developer</h3>
                            <p>Some text goes here that describes about team member</p>
                            <h4>neehal.180410116029@gmail.com</h4>
                        </div>
                    </div>
                </div>
                <div class="column">
                    <div class="team-2">
                        <div class="team-img">
                            <img src="img/team/jathin.jpg" alt="Team Image">
                            <div class="team-social">
                                <a target="_blank" class="social-tw" href="https://twitter.com/jathin_prakash"><i class="fab fa-twitter"></i></a>
                                <a target="_blank" class="social-fb" href="https://www.facebook.com/jathin.prakash.3/"><i class="fab fa-facebook-f"></i></a>
                                <a target="_blank" class="social-li" href="https://www.linkedin.com/in/jathin-prakash/"><i class="fab fa-linkedin-in"></i></a>
                                <a target="_blank" class="social-in" href="https://www.instagram.com/jp4106/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="team-content">
                            <h2>Jathin Prakash</h2>
                            <h3>Developer</h3>
                            <p>Some text goes here that describes about team member</p>
                            <h4>jathin.180410116033@gmail.com</h4>
                        </div>
                    </div>
                </div>
            </div> 
